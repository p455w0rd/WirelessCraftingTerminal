...
public class ModRecipes {
	...
	public static void init() {
		...
		ForgeRegistries.RECIPES.register(new ShapelessOreRecipe(ModItems.WCT.getRegistryName(), new ItemStack(ModItems.WCT), new Object[] {
				wt,
				fluixPearl,
				craftingTerminal
		}).setRegistryName(ModItems.WCT.getRegistryName()));
		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(ModItems.MAGNET_CARD.getRegistryName(), new ItemStack(ModItems.MAGNET_CARD), new Object[] {
				"abc",
				"ded",
				"ddd",
				Character.valueOf('a'),
				...
				Character.valueOf('e'),
				advancedCard
		}).setRegistryName(ModItems.MAGNET_CARD.getRegistryName()));

		if (!ModConfig.WCT_DISABLE_BOOSTER_RECIPE) {
			ForgeRegistries.RECIPES.register(new ShapedOreRecipe(ModItems.BOOSTER_CARD.getRegistryName(), new ItemStack(ModItems.BOOSTER_CARD), new Object[] {
					"a a",
					" b ",
					"   ",
					Character.valueOf('a'),
					...
					Character.valueOf('b'),
					wap
			}).setRegistryName(ModItems.BOOSTER_CARD.getRegistryName()));
		}
	}
