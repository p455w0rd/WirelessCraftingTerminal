...
public class GuiMagnet extends GuiContainer {
	...
	public void initGui() {
		...
		if (!myIcon.isEmpty() && GuiWCT.isSwitchingGuis()) {
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		if (getSlotUnderMouse() == null || (getSlotUnderMouse() != null && !getSlotUnderMouse().getStack().isEmpty() && !(getSlotUnderMouse().getStack().getItem() instanceof IWirelessCraftingTerminalItem))) {
