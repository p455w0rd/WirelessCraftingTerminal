...
public class GuiWCT extends WCTBaseGui implements ISortSource, IConfigManagerHost, IMTModGuiContainer2 {
	...
	void setReservedSpace(final int reservedSpaceIn) {
		reservedSpace = reservedSpaceIn;
	}
	...
	void setStandardSize(final int standardSizeIn) {
		standardSize = standardSizeIn;
	}
	...
	public void initGui() {
		...
		searchField = new MEGuiTextField(fontRenderer, SEARCH_X, SEARCH_Y, SEARCH_WIDTH, SEARCH_HEIGHT);
	...
	void setCustomSortOrder(final boolean customSortOrderIn) {
		customSortOrder = customSortOrderIn;
	}
