...
public enum WCTStateIconsEnum implements IStateIconTexture {
	...
	// Slot backgrounds
	VIEW_CELL_BACKGROUND(224, 64), UPGRADE_CARD_BACKGROUND(240, 208), ME_CELL_BACKGROUND(240,
			0), PATTERN_CELL_BACKGROUND(240, 128),
	...
	// Misc
	WRENCH(32, 64), DISABLED(0, 128), ENABLED(16, 128), SAVE(0, 176), DELETE(0, 192), CLEAR_GRID(96, 0), ARROW_DOWN(128, 0);

	/**
	 * Location of the AE states texture
	 */
	public static final ResourceLocation AE_STATES_TEXTURE = new ResourceLocation("appliedenergistics2",
