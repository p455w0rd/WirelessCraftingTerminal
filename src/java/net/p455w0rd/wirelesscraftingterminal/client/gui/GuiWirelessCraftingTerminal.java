...
public class GuiWirelessCraftingTerminal extends GuiContainer implements ISortSource, IConfigManagerHost
{
	...
	public static int tick = 0, GUI_HEIGHT = 240, GUI_WIDTH = 198, AE_ROW_HEIGHT = 18, AE_NUM_ROWS = 3, GUI_UPPER_HEIGHT = 35, GUI_SEARCH_ROW = 35,
			SEARCH_X = 81, SEARCH_Y = 6, SEARCH_WIDTH = 88, SEARCH_HEIGHT = 10, SEARCH_MAXCHARS = 15, GUI_LOWER_HEIGHT, AE_TOTAL_ROWS_HEIGHT,
					BUTTON_SEARCH_MODE_POS_X = -18, BUTTON_SEARCH_MODE_POS_Y = 68, BUTTON_SIZE = 16, NEI_EXTRA_SPACE = 30, slotYOffset;
	...
	/**
	 * Called every tick. It is used in this instance
	 * to detect screen size changes to automatically
	 * update the gui height.
	 * 
	 * reInit variable is used to call initGui() on
	 * the next tick. It has to be called this way to
	 * update correctly.
	 * 
	 * @author p455w0rd
	 */
